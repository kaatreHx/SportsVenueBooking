...
from .apis import TimeSlotViewSet, BookingsViewSet, PaymentProofViewSet, AvailableSlotsAPIView, StaffDashboardAPIView, TimeSlotViewSet
...
urlpatterns = [
    ...
    path('staff-dashboar/', StaffDashboardAPIView.as_view(), name='staff-dashboard'),
]